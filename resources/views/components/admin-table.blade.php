<div class="tabel mt-4">
  <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
    <table class="w-full text-left text-base text-gray-500 dark:text-gray-400 rtl:text-right">
      <thead class="bg-green-500 text-sm uppercase text-white dark:bg-gray-700 dark:text-gray-400">
        <tr>
            ...
            <tr class="border-b bg-white hover:bg-gray-50 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-600">
              ...
              <td class="flex items-center justify-center gap-4 px-6 py-4 text-white">
                ...
                <button data-modal-target="popup-modal" data-modal-toggle="popup-modal"
                  class="flex items-center rounded-lg bg-red-700 p-2 text-center font-medium text-white hover:bg-red-800"
                  type="button">
                  <svg class="h-6 w-6 text-white dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
                    width="24" height="24" fill="none" viewBox="0 0 24 24">
                    <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
