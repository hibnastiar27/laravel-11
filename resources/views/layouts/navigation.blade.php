    ...
    <div class="flex h-full flex-col gap-2">
      ...
      <div class="my-2 space-y-2 font-medium">
        <a href="{{ route('admin.dashboard') }}"
          class="{{ request()->routeIs('admin.dashboard') ? 'border-green-300 bg-green-100 font-bold text-green-500  hover:border-green-600 hover:bg-green-200 hover:text-green-600' : '' }} group flex items-center rounded-lg border border-transparent p-2 text-gray-900 duration-300 hover:bg-green-100 dark:text-white dark:hover:bg-gray-700">
          <svg
            class="{{ request()->routeIs('admin.dashboard') ? 'text-green-500 group-hover:text-green-600' : '' }} h-5 w-5 text-gray-500 transition duration-300 group-hover:text-gray-900 dark:text-gray-400 dark:group-hover:text-white"
        ...
        <a href="{{ route('admin.kategori') }}"
          class="{{ request()->routeIs('admin.kategori') ? 'border-green-300 bg-green-100 font-bold text-green-500  hover:border-green-600 hover:bg-green-200 hover:text-green-600' : '' }} group flex items-center rounded-lg border border-transparent p-2 text-gray-900 duration-300 hover:bg-green-100 dark:text-white dark:hover:bg-gray-700">
          <svg
            class="{{ request()->routeIs('admin.kategori') ? 'text-green-500 group-hover:text-green-600' : '' }} h-5 w-5 text-gray-500 transition duration-300 group-hover:text-gray-900 dark:text-gray-400 dark:group-hover:text-white"
        ...
        <a href="{{ route('admin.artikel') }}"
          class="{{ request()->routeIs('admin.artikel') ? 'border-green-300 bg-green-100 font-bold text-green-500  hover:border-green-600 hover:bg-green-200 hover:text-green-600' : '' }} group flex items-center rounded-lg border border-transparent p-2 text-gray-900 duration-300 hover:bg-green-100 dark:text-white dark:hover:bg-gray-700">
          <svg
            class="{{ request()->routeIs('admin.artikel') ? 'text-green-500 group-hover:text-green-600' : '' }} h-5 w-5 text-gray-500 transition duration-300 group-hover:text-gray-900 dark:text-gray-400 dark:group-hover:text-white"
